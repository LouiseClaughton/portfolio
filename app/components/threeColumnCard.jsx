export default function ThreeColumnCard({ block, id }) {
  ...
  return (
    <div
      className="flex flex-col justify-center text-center pt-12 pb-24"
    >
      ...
      <div
        id={id}
        className="w-screen flex flex-col max-w-full md:grid md:grid-cols-3 gap-12 md:gap-24 px-12 md:px-24"
      >
